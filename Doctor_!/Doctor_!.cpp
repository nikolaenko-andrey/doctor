...
// Doctor_!.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDoctor_App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CDoctor_App

CDoctor_App::CDoctor_App()
{
...
// Единственный объект CDoctor_App

CDoctor_App theApp;


// инициализация CDoctor_App

BOOL CDoctor_App::InitInstance()
{
